...
Da lista da onda (seção 12.5 da Especificação v2.0 / seção 8 do `PETLYS_PILAR1_PLANO_100_PERCENT.md`), o usuário decidiu em 2026-09-02 adiar 2 dos 5 itens; os outros 3 (seguro/garantia, backup de emergência, proteção de conversa) ficam em discussão de produto, fora deste arquivo por enquanto.
